          ...
          SliverPadding(
            ...
            sliver: SliverList(
              delegate: SliverChildListDelegate([
                ...
                _ReviewCard(cardsDue: cardsDue, cardsToday: cardsToday)
        ...
        child: Row(
          children: [
            ...
            FilledButton(
              ...
              child: Text(isDone ? '再練習' : '開始', style: const TextStyle(fontSize: 13)),
            ),
          ],
        ),
      ),
...
class _QuickActionsGrid extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    ).animate(interval: 60.ms).fadeIn().slideY(begin: 0.04);
  }
}
